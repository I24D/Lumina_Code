...
describe("PROVIDER_TOOL_SUPPORT", () => {
  ...
  describe("ollama", () => {
    ...
    it("should support selected Ollama Cloud tool models", () => {
      expect(supportsFn("glm-5.2:cloud")).toBe(true);
      expect(supportsFn("kimi-k3:cloud")).toBe(true);
    });
    ...
    it("should return false for explicitly unsupported models", () => {
      ...
      expect(supportsFn("glm-5:cloud")).toBe(false);
    });
