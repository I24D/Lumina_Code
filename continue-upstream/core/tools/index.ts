...
export const getBaseToolDefinitions = () => [
  ...
  toolDefinitions.luminaWindowsBridgeTool,
  toolDefinitions.luminaWhatsAppTool,
  toolDefinitions.luminaPhoneLinkTool,
  toolDefinitions.luminaRuntimeTool,
  toolDefinitions.luminaImageGenTool,
  toolDefinitions.luminaVideoGenTool,
  toolDefinitions.luminaCreateSkillTool,
