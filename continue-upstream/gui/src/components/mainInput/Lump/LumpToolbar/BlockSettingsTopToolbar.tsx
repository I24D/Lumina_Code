...
import { toggleFullAccess } from "../../../../redux/slices/uiSlice";
...
export function BlockSettingsTopToolbar() {
  ...
  const fullAccess = useAppSelector((store) => store.ui.fullAccess);
        ...
        {!hasActiveContent && (
          <div className="flex items-center gap-1.5">
            <ToolTip
              content={
                fullAccess
                  ? "Full access active: tool calls run without manual approval"
                  : "Enable Full access for automatic tool approval"
              }
            >
              <Button
                ...
                onClick={() => dispatch(toggleFullAccess())}
              >
