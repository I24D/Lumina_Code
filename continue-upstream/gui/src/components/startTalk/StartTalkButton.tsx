      ...
      <ToolTip place="top" content="Start talk">
        <Button
          ...
          onClick={(event) => {
            ...
            // Abre Start Talk como orbe de escritorio flotante (fuera de VS Code),
            // no como overlay dentro del panel. El comando arranca el bridge y
            // lanza la ventana Tauri con la MISMA UI. Ver extension/startTalkOrb.ts.
