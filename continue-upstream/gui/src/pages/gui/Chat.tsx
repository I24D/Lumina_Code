...
import { LuminaAvatarIcon, LuminaAvatarStrip } from "./LuminaAvatarStrip";
...
const AssistantMessageRow = styled.div`
  display: grid;
...
const AssistantAvatarSlot = styled.div`
  display: flex;
      ...
      if (message.role === "assistant") {
        return (
          <>
            ...
            <AssistantMessageRow className="thread-message">
              <AssistantAvatarSlot>
                <LuminaAvatarIcon className="h-6 w-6 object-contain" />
              </AssistantAvatarSlot>
              <TimelineItem
                item={item}
                iconElement={
                  <LuminaAvatarIcon className="h-4 w-4 object-contain" />
                }
                open={
