          ...
          if (toolCallState) {
            ...
            if (accepted) {
              if (toolCallState.status !== "errored") {
                void extra.ideMessenger.request("lumina/reportToolResult", {
                ...
                void extra.ideMessenger.request("lumina/reportToolResult", {
                  toolCall: toolCallState.toolCall,
                  result: {
                    errorMessage: `Failed to edit ${applyState.filepath}.`,
                  },
                });
            ...
            if (!accepted) {
              void extra.ideMessenger.request("lumina/reportToolResult", {
                toolCall: toolCallState.toolCall,
                result: {
                  errorMessage: `Edit rejected for ${applyState.filepath}.`,
                },
              });
            }
          }
