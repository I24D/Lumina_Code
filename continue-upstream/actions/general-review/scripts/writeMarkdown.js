...
WARNING: AI review skipped: CONTINUE_API_KEY not configured.
...
WARNING: AI review skipped: Continue CLI installation failed.
...
WARNING: Continue CLI returned an empty response. Please check the configuration.
`,
  cli_not_found: `## Code Review Summary

WARNING: Continue CLI is not properly installed. Please ensure @continuedev/cli is installed globally.
`,
  config_error: `## Code Review Summary

WARNING: Continue configuration error. Please verify that the assistant exists in Continue Hub.
`,
  auth_error: `## Code Review Summary

WARNING: Continue API authentication failed. Please check your CONTINUE_API_KEY.
`,
  generic_failure: `## Code Review Summary

WARNING: AI review failed. Please check the Continue API key and configuration.
